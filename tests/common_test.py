...
class TestCommon(unittest.TestCase):
    ...
    def test_parsedatetime(self):
        ...
        self.assertEqual(parse_datetime("2022-02-15T08"),
                         datetime(2022, 2, 15, 8))
        self.assertEqual(parse_datetime("2023-03-11T12_20"),
                         datetime(2023, 3, 11, 12, 20))
        self.assertEqual(parse_datetime("2023-03-11T12-20-15"),
                         datetime(2023, 3, 11, 12, 20, 15))
        self.assertEqual(parse_datetime("2023-03-11_12-20"),
                         datetime(2023, 3, 11, 12, 20))
        self.assertEqual(parse_datetime("20230311_1220"),
                         datetime(2023, 3, 11, 12, 20))
